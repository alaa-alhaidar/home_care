...
<body class="bg02">
    ...
    <div class="container-fluid " id="home"">
        ...
        <div class="bg-white" id="navbarSupportedContent">
            ...
            <h2 style=" font-size: 50px; color: rgb(235, 27, 27); font-family:sans-serif; font-weight: 500;"
                ...
                <b>Patienten: Name. {{$pat->nachname}}, Vorname. {{$pat->vorname}}, Geb. {{$pat->geburtstag}}, f. Code.
                    {{$pat->f_code}}.</b>
    ...
    const apikey = 'sk-proj-YjOh7MXuabAmcWJ8W9rxT3BlbkFJOFu9GzqwzloR9joSNMdy'; // Replace with your OpenAI API key
    ...
    if ($timeNow >= 6 && $timeNow <= 9) { $medplan .=DB::table('medikaments') ->where('f_code', $pat->f_code)
        ...
        }else if ($timeNow > 9 && $timeNow <= 18) { $medplan .=DB::table('medikaments') ->where('f_code', $pat->f_code)
            ->where('nachmittag', '>', 0)
            ->get(['name','nachmittag']);
                ...
                ->get(['name','abend']);
                ...
                }else if ($timeNow > 21 && $timeNow <= 24) { $medplan .=DB::table('medikaments') ->where('f_code',
                    $pat->f_code)
                    ->where('nachts', '>', 0)
                    ->get(['name','nachts']);
                    }
                    ...
                    <div id="popup"
                        class="popup alert alert-warning alert-dismissible fade show fs-2 text-center align-middle"
                        onclick="hidePopup()">
                    ...
                    <footer>
                        ...
                        <div class="bg-white fs-3">
                            <b style="text-align: center;color:red;">Alaa Al Haidar TU Berlin Abschlussarbeit Fakultaet
                                IV</b>
                        </div>
