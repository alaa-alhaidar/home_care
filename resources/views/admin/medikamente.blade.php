    ...
    <div class="container-fluid " id="home"">
        ...
        <div class="bg-white" id="navbarSupportedContent">
            ...
            <h2 style=" font-size: 50px; color: rgb(235, 27, 27); font-family:sans-serif; font-weight: 500;"
                    ...
                    <b>Patienten: Name. {{$pat->nachname}}, Vorname. {{$pat->vorname}}, Geb. {{$pat->geburtstag}}, f. Code. {{$pat->f_code}}.</b>
                    ...
                    <div class="bg-white  tm-block h-100">
                        <div class="row">
                            ...
                            <div class=" container-fluid bs-border-color col" id="">
                                <form class= 'd-inline' action="{{ route('pat_info',['f_code' => $pat->f_code,'patinfo' => $pat->f_code]) }}"  method='get'>
                                    @csrf
