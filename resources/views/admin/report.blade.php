                ...
                <div class="">
                    <div class="bg-white  tm-block">
                        ...
                        <div class="table-responsive fs-5">
                            ...
                            <table id="medikamente-table" class="table table-hover bg-secondary border-bottom border-white">
                            ...
                            <tbody class="fw-normal">
                                ...
                                <td> 
                                    ...
                                    <form class= 'd-inline' action="{{ route('edit-report',['f_code' => $pat->f_code,'patinfo' => $pat->f_code,'id' => $item->id]) }}" method='post'>
                                        @csrf
